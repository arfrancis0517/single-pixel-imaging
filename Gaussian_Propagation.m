...
if (nargin < 5); f=[0.25 0.218 0.055 0.0153]; end
if (nargin < 4); fpos=[0.25 0.69 0.98 1.25]; end
if (nargin < 3);  wp=0; end
if (nargin < 2); beam_waist=0.5e-3; end
if (nargin < 1); lambda=8.6896e-4; end
